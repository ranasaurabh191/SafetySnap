...
import { Menu, User, LogOut, Sun, Moon, ShieldCheck, Home, AlertCircle } from 'lucide-react'; // Add Home icon
  ...
  return (
    <header className="mx-4 mt-4 mb-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        {/* Right: Home link, theme toggle, notifications, and user menu */}
        <div className="flex items-center gap-2">
          {/* Home Link */}
          <button
            onClick={() => navigate('/home')}
            className="hidden sm:flex items-center gap-1 px-3 py-2 text-orange-600 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20 rounded-xl transition-all font-semibold"
            title="Go to Home"
          >
